export default function UsersLoading() {
  return (
    <div className="space-y-5 animate-pulse">
      {/* Heading */}
      <div className="h-7 w-32 bg-[#e5e3de] rounded-lg" />
      ...
      <div className="bg-white rounded-2xl border border-[#e5e3de] overflow-hidden">
        ...
        <div className="border-b border-[#e5e3de] bg-[#faf9f7] px-4 py-3 flex gap-4">
          {[260, 80, 80, 60, 60, 80, 100, 80].map((w, i) => (
        ...
        {Array.from({ length: 10 }).map((_, i) => (
          <div key={i} className="px-4 py-3 flex items-center gap-4 border-b border-[#f0ede7]">
            <div className="flex items-center gap-3 w-[260px]">
              <div className="w-8 h-8 rounded-full bg-[#e5e3de] flex-shrink-0" />
              <div className="space-y-1.5">
                <div className="h-3 w-28 bg-[#e5e3de] rounded" />
                <div className="h-2.5 w-36 bg-[#ebe9e4] rounded" />
              </div>
            </div>
            <div className="h-5 w-16 bg-[#e5e3de] rounded-full" />
            <div className="h-5 w-14 bg-[#e5e3de] rounded-full" />
            <div className="h-4 w-8 bg-[#e5e3de] rounded ml-auto" />
            <div className="h-4 w-6 bg-[#e5e3de] rounded" />
            <div className="h-4 w-6 bg-[#e5e3de] rounded" />
