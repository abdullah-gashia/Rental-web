    ...
    <form onSubmit={handleSubmit} className="p-5 sm:p-6 space-y-6">
      ...
      <div className="flex items-center gap-4 p-4 bg-[var(--c-subtle)] rounded-xl border border-[var(--c-line)]">
        ...
        >
          ...
          <span className="absolute inset-0 bg-[rgba(10,25,47,.55)] text-white text-[10.5px] font-semibold flex items-center justify-center opacity-0 group-hover:opacity-100 transition">
            เปลี่ยนรูป
          </span>
        </button>
        ...
        <div className="min-w-0">
          ...
          >
            {avatar ? "เปลี่ยนรูปโปรไฟล์" : "เพิ่มรูปโปรไฟล์"}
          </button>
          <p className="text-[10.5px] text-[var(--c-faint)] mt-1.5">
            ไฟล์รูปทุกชนิด ทุกขนาด — เลือกมุมที่จะแสดงได้เอง
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {/* Name */}
        <div>
          <label className="block text-sm font-medium text-[var(--c-ink-1)] mb-1">
            ชื่อที่แสดง <span className="text-[var(--c-danger)]">*</span>
          </label>
          <input
            type="text"
            value={name}
        ...
        <div>
          <label className="block text-sm font-medium text-[var(--c-ink-1)] mb-1">
            อีเมล <span className="text-[var(--c-faint)]">🔒</span>
          </label>
          <input
            type="email"
        ...
        <div>
          <label className="block text-sm font-medium text-[var(--c-ink-1)] mb-1">
            แนะนำตัว <span className="text-[var(--c-faint)] text-xs">(ไม่บังคับ)</span>
          </label>
          <textarea
            value={bio}
      ...
      <div className="border-t border-[var(--c-line)] pt-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-4 bg-[var(--c-subtle)] rounded-xl border border-[var(--c-line)]">
          <div>
            <span className="text-[11px] text-[var(--c-muted)] uppercase tracking-wider">สถานะ</span>
          ...
          <div>
            <span className="text-[11px] text-[var(--c-muted)] uppercase tracking-wider">ประเภท</span>
          ...
          <div>
            <span className="text-[11px] text-[var(--c-muted)] uppercase tracking-wider">รหัส PSU</span>
            <p className="text-sm font-medium text-[var(--c-ink-1)] mt-0.5 font-mono">
              {userData.psuIdNumber ?? "—"}
            </p>
          </div>
          <div>
            <span className="text-[11px] text-[var(--c-muted)] uppercase tracking-wider">บทบาท</span>
            <p className="text-sm font-medium text-[var(--c-ink-1)] mt-0.5">
