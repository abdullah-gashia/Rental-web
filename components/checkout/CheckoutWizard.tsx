  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="relative bg-[var(--c-surface)] w-full sm:max-w-[520px] rounded-t-3xl sm:rounded-3xl sm:mb-0"
          style={{
        ...
        >
          ...
          <div className="px-6 pb-4">
            ...
            {state.error && (
              <div className="mb-4 px-4 py-3 rounded-xl bg-[var(--c-danger-soft)] border border-[var(--c-danger-line)] text-sm text-[var(--c-danger)] font-medium">
                ❌ {state.error}
              </div>
            )}
          ...
          {/* ── Footer navigation ──────────────────────────────────────────────── */}
          <div
            className="px-6 py-4 border-t border-[var(--c-line)] bg-[var(--c-surface)] rounded-b-3xl"
