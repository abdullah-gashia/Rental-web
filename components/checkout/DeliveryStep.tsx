    ...
    <div className="space-y-3 mt-4">
      ...
      {savedAddresses.length > 0 && (
        <div>
              ...
              <button
                ...
                className={`w-full text-left px-3 py-2.5 rounded-xl border text-sm transition ${
                  state.savedAddressId === sa.id
                    ? "border-blue-500 bg-[var(--c-accent-soft)]"
          ...
          <div className="border-t border-[var(--c-line)] my-3" />
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="relative">
          ...
          {showProvinces && filteredProvinces.length > 0 && (
            <div className="absolute z-20 top-full left-0 right-0 mt-1 bg-[var(--c-surface)] border border-[var(--c-line)] rounded-xl shadow-lg max-h-40 overflow-y-auto">
              {filteredProvinces.slice(0, 10).map((p) => (
                <button
                  ...
                  className="w-full text-left px-3 py-2 text-sm hover:bg-[var(--c-canvas)] transition"
                >
                  {p}
                </button>
              ))}
      ...
      {/* Save checkbox */}
      <label className="flex items-center gap-2 cursor-pointer text-sm text-[var(--c-ink-2)] mt-1">
        <input
          type="checkbox"
